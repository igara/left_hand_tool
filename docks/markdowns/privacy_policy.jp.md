# Privacy policy for left_hand_tool developed by syo_igarashi

## left_hand_tool のプライバシーポリシー

本プライバシーポリシーは、syo_igarashi（以下、「当開発者」）が開発した left_hand_tool(以下、「拡張機能」とします。)の利用において、利用者の個人情報もしくはそれに準ずる情報を取り扱う際に、当開発者が遵守する方針を示したものです。
...
対象のノードをダブルクリックすることで HTML などの生成を行います
